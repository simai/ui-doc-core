<div class="sf-settings-wrap sf-float-wrap">
    <button onclick="toggleFloat(this)" title="{{$page->translate('settings')}}"
            class="sf-icon-button sf-button-settings  sf-icon-button--size-1 sf-icon-button--link sf-icon-button--on-surface">
    ...
    <div class="sf-settings-menu bg-surface-overlay">
        ...
        [!Radio className=lang_size name=radio_switch](size=1 count=3 text=A title="{{$page->translate('text size')}}"
