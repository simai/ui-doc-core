...
<button onclick="toggleFloat(this)" title="{{$page->translate('settings')}}" class="sf-button sf-button-settings  sf-button--size-1 sf-icon-button--size-1 sf-button--link sf-button--on-surface">
